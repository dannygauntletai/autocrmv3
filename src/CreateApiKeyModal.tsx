      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="e.g., Production API Key" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Permissions
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="write" className="text-sm text-gray-700">
                  Write access
                </label>
              </div>
            </div>
